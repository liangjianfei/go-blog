...
type SysBaseMenu struct {
	...
	Sort          int    `json:"sort" gorm:"comment:排序标"`
	Meta          `json:"meta" gorm:"embedded;comment:附加属性"`
	SysAuthoritys []SysAuthority         `json:"sysAuthoritys" gorm:"many2many:sys_authority_menus;"`
...
type Meta struct {
	...
	DefaultMenu bool   `json:"defaultMenu" gorm:"comment:是否是基础luy"`
